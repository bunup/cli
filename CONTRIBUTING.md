...
2. Clone your fork: `git clone https://github.com/bunup/cli.git`
3. Navigate to the project directory: `cd cli`
...
If you have any questions, please [open an issue](https://github.com/bunup/cli/issues/new) for discussion.

Thank you for contributing to cli!
